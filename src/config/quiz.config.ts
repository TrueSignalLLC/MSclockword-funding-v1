...
export const quizConfig = {
  ...
  submission: {
    ...
    consent: {
      text: 'By clicking "Get My Options", you expressly consent to be contacted by YourHomeSecured and our security partners at the number/email provided (including autodialed, prerecorded, and text messages) regarding home security solutions. You also consent to receive marketing, service notifications, and account updates via SMS messaging. Consent not required to buy. Message & data rates may apply. Messaging frequency may vary. Reply STOP to opt out of texts. See our <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Privacy Policy</a>, <a href="/terms-of-service" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Terms of Service</a>, and <a href="/privacy-policy#California Privacy Rights (CCPA)" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">California Privacy Rights</a>.',
      required: true
    },
